    ...
    >
      ...
      <SectionContainer>
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              <a href="https://twitter.com/fonoster" className="text-gray-300 hover:text-gray-400">
              ...
              <a href="https://github.com/fonoster" className="text-gray-300 hover:text-gray-400">
        ...
        <div className="mt-32 border-t dark:border-dark pt-8 flex justify-between">
          <p className="text-base text-gray-400 dark:text-dark-400">&copy; Fonoster Inc</p>
