...
- Google Cloud Credentials with access to Speech APIs and Dialogflow 
- Docker & Docker Compose

## Overview

Y ou can listen to the final result in the followin video:
...
You are all set! In the output, look for Ngrok's URL and use the value as the Webhook of your Fonoster Number.